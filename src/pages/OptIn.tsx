          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-4 items-center min-h-[calc(100vh-48px)]">
            ...
            <div className="lg:col-span-7 flex flex-col lg:flex-row items-center gap-8 lg:gap-12 py-16 lg:py-0">
              ...
              <div className="order-1 lg:order-2 text-center lg:text-left">
                ...
                >
                  Never Miss
                  <span className="block italic mt-1 text-5xl md:text-6xl xl:text-7xl whitespace-nowrap">An<span className="relative inline-block bg-accent text-accent-foreground px-3 py-1 pb-2 ml-2 -skew-x-3 shadow-[0_0_30px_hsl(var(--accent)/0.4)]">Update</span></span>
                </motion.h1>
